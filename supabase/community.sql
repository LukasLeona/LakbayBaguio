...
begin
  ...
  -- Serialize starts for the caller and the traveler pair so simultaneous taps
  -- cannot create duplicate conversations or bypass the hourly start limit.
  ...
  -- Keep a compact audit/rate-limit record without requiring receiver approval.
